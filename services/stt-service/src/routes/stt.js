...
const COMMANDS = [
  { keywords: ['질문 읽어'], type: 'READ_QUESTION' },           // 질문 읽기
  { keywords: ['질문', '다시'], type: 'READ_QUESTION_AGAIN' },  // 질문 다시 읽기
  { keywords: ['비공개', '완료'], type: 'END_PRIVATE' },        // 비공개 질문 답변 완료
  { keywords: ['답변', '완료'], type: 'COMPLETE_ANSWER' },      // 일반/유료 공개 질문 답변 완료
  { keywords: ['다음', '질문'], type: 'NEXT_QUESTION' },        // 다음 질문으로 넘어가기
  { keywords: ['비공개', '답변'], type: 'START_PRIVATE' },      // 비공개 질문 답변 시작
];
